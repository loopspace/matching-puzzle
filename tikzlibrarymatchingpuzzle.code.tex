...
% Sequence of triangle sides
\seq_new:N \l__jigsaw_hexagon_sides_seq

\seq_push:Nn \l__jigsaw_hexagon_sides_seq {*13,{},*30}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {30,{},*24}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {*23,{},*29}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {29,{},*22}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {*21,{},*28}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {28,{},*20}

\seq_push:Nn \l__jigsaw_hexagon_sides_seq {*19,{},*27}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {27,{},*18}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {*17,{},*26}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {26,{},*16}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {*15,{},*25}
\seq_push:Nn \l__jigsaw_hexagon_sides_seq {25,{},*14}
...
\DeclareDocumentCommand \AddSide { m m }
{
  ...
  {
    \seq_put_right:Nn \l__jigsaw_sides_seq {{#2}{#1}}
  }
}
...
\cs_new_nopar:Npn \jigsaw_typeset_first_side:n #1
{
  ...
  {
    \exp_last_unbraced:Nx \use_i:nn  {\seq_item:Nn \l__jigsaw_sides_seq {#1}}
  }
}
...
\cs_new_nopar:Npn \jigsaw_typeset_second_side:n #1
{
  \int_compare:nT {#1 <= \seq_count:N \l__jigsaw_sides_seq}
  {
    \exp_last_unbraced:Nx \use_ii:nn  {\seq_item:Nn \l__jigsaw_sides_seq {#1}}
  }
}
...
\DeclareDocumentCommand \ShuffleSides {}
{
  \seq_shuffle:N \l__jigsaw_sides_seq
}

\DeclareDocumentCommand \ShufflePieces {}
{
  \seq_shuffle:N \l__jigsaw_hexagon_sides_seq
}
